...
public class ScrapController {
    ...
    @GetMapping("/valid")
    public ResponseEntity<Boolean> isScrapped(@RequestParam String careaCode, @RequestParam String jcateogryCode) {
        Member loginMember = new Member(); // 현재 로그인 한 유저
    ...
    @GetMapping
    public ResponseEntity<List<ScrapResponse>> getScrapResponses() {
        Member loginMember = new Member(); // 현재 로그인 한 유저
